.class public Lcom/gpc/sdk/eventcollection/internal/filter/UserPreferencesFilter;
...
# static fields
.field private static final TAG:Ljava/lang/String; = "UserPreferencesFilter"
...
.method public isAcceptable(Lcom/gpc/sdk/eventcollection/internal/bean/EventPacket;)Z
    ...
    .line 2
    const-string v0, "_.user_preferences"
    ...
    .line 3
    const-string p1, "UserPreferencesFilter"

    const-string v0, "user_preferences event off."
