.class public Lcom/gpc/sdk/service/interceptors/PreDebugInterceptor;
...
.method public interceptRequest(Lcom/gpc/sdk/service/network/http/request/HTTPRequest;)V
    ...
    .line 3
    invoke-static {}, Lcom/gpc/sdk/utils/modules/ModulesManager;->getPreConfigManager()Lcom/gpc/sdk/utils/modules/preenv/PreDebugConfigManager;

    move-result-object v0

    invoke-virtual {v0}, Lcom/gpc/sdk/utils/modules/preenv/PreDebugConfigManager;->getLocalConf()Lcom/gpc/sdk/utils/modules/conf/PreLocalConf;
    ...
    invoke-virtual {v2}, Lcom/gpc/sdk/utils/modules/conf/PreDebugProfile;->getHttpRules()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/gpc/sdk/utils/modules/conf/PreDebugProfile;->getHttpRules()Ljava/util/List;
    ...
    check-cast v2, Lcom/gpc/sdk/utils/modules/conf/HttpRule;

    .line 10
    :try_start_0
    invoke-virtual {v2}, Lcom/gpc/sdk/utils/modules/conf/HttpRule;->getRegex()Ljava/lang/String;
    ...
    .line 15
    invoke-virtual {v2}, Lcom/gpc/sdk/utils/modules/conf/HttpRule;->getModifiedUrl()Ljava/lang/String;
    ...
    invoke-virtual {p1, v3}, Lcom/gpc/sdk/service/network/http/request/HTTPRequest;->changeUrl(Ljava/lang/String;)V

    .line 20
    :cond_1
    invoke-virtual {v2}, Lcom/gpc/sdk/utils/modules/conf/HttpRule;->getQuerys()Ljava/util/Map;
    ...
    invoke-virtual {p1, v3, v4}, Lcom/gpc/sdk/service/network/http/request/HTTPRequest;->appendQuery(Ljava/util/Map;Z)V

    .line 25
    :cond_2
    invoke-virtual {v2}, Lcom/gpc/sdk/utils/modules/conf/HttpRule;->getHeaders()Ljava/util/Map;
    ...
    invoke-virtual {v5, v4, v6}, Lcom/gpc/sdk/service/network/http/request/HTTPRequestHeaders;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
