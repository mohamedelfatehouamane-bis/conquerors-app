.class public final Lcom/gpc/cropper/CropImage;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/gpc/cropper/CropImage$ActivityBuilder;,
...
.method public static activity()Lcom/gpc/cropper/CropImage$ActivityBuilder;
    .locals 2

    .line 435
    new-instance v0, Lcom/gpc/cropper/CropImage$ActivityBuilder;

    const/4 v1, 0x0

    invoke-direct {v0, v1, v1}, Lcom/gpc/cropper/CropImage$ActivityBuilder;-><init>(Landroid/net/Uri;Lcom/gpc/cropper/CropImage$1;)V

    return-object v0
.end method

.method public static activity(Landroid/net/Uri;)Lcom/gpc/cropper/CropImage$ActivityBuilder;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lcom/gpc/cropper/CropImage$ActivityBuilder;-><init>(Landroid/net/Uri;Lcom/gpc/cropper/CropImage$1;)V

    return-object v0
.end method

.method public static getActivityResult(Landroid/content/Intent;)Lcom/gpc/cropper/CropImage$ActivityResult;
    .locals 1
    ...
    check-cast p0, Lcom/gpc/cropper/CropImage$ActivityResult;
...
.method public static getCameraIntent(Landroid/content/Context;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    .line 246
    invoke-static {p0}, Lcom/gpc/cropper/CropImage;->getCaptureImageOutputUri(Landroid/content/Context;)Landroid/net/Uri;
...
.method public static getPickImageChooserIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-static {p0, v2, v0, v1}, Lcom/gpc/cropper/CropImage;->getPickImageChooserIntent(Landroid/content/Context;Ljava/lang/CharSequence;ZZ)Landroid/content/Intent;
...
.method public static getPickImageChooserIntent(Landroid/content/Context;Ljava/lang/CharSequence;ZZ)Landroid/content/Intent;
    ...
    .line 203
    invoke-static {p0}, Lcom/gpc/cropper/CropImage;->isExplicitCameraPermissionRequired(Landroid/content/Context;)Z
    ...
    .line 204
    invoke-static {p0, v1}, Lcom/gpc/cropper/CropImage;->getCameraIntents(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 208
    invoke-static {v1, p0, p2}, Lcom/gpc/cropper/CropImage;->getGalleryIntents(Landroid/content/pm/PackageManager;Ljava/lang/String;Z)Ljava/util/List;
...
.method public static isExplicitCameraPermissionRequired(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, Lcom/gpc/cropper/CropImage;->hasPermissionInManifest(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 324
    invoke-static {p0, v0}, Landroidx/core/graphics/ColorKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;Ljava/lang/String;)I
...
.method public static isReadExternalStoragePermissionsRequired(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    .line 402
    invoke-static {p0, p1}, Lcom/gpc/cropper/CropImage;->isUriRequiresPermissions(Landroid/content/Context;Landroid/net/Uri;)Z
...
.method public static startPickImageActivity(Landroid/app/Activity;)V
    ...
    .line 153
    invoke-static {p0}, Lcom/gpc/cropper/CropImage;->getPickImageChooserIntent(Landroid/content/Context;)Landroid/content/Intent;
