.class public Lcom/gpc/operations/permision/impl/GPCPermission;
...
# instance fields
.field protected listener:Lcom/gpc/operations/permision/listener/OnRequestPermissionResultHandleListener;
...
.method public constructor <init>()V
    ...
    .line 5
    iput v0, p0, Lcom/gpc/operations/permision/impl/GPCPermission;->requestCode:I

    return-void
.end method

.method private gotoDefaultAppPermissionSettingPage(Landroid/content/Context;Ljava/lang/String;)V
    .locals 3
...
.method public gotoAppPermissionSettingPage(Landroid/content/Context;)V
    ...
    .line 4
    invoke-direct {p0, p1, v1}, Lcom/gpc/operations/permision/impl/GPCPermission;->gotoDefaultAppPermissionSettingPage(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public handlePermissionResult(Landroid/app/Activity;I[Ljava/lang/String;[I)V
    ...
    .line 24
    invoke-virtual {p0, p1, p2, v2}, Lcom/gpc/operations/permision/impl/GPCPermission;->permissionNoAsked(Landroid/app/Activity;ILjava/util/List;)V
...
.method public permissionDenied(Landroid/app/Activity;ILjava/util/List;)V
    ...
    .line 2
    invoke-interface {v0, p1, p2, p3}, Lcom/gpc/operations/permision/listener/OnRequestPermissionResultHandleListener;->onPermissionDenied(Landroid/app/Activity;ILjava/util/List;)V
...
.method public permissionGranted(Landroid/app/Activity;ILjava/util/List;)V
    ...
    .line 2
    invoke-interface {v0, p1, p2, p3}, Lcom/gpc/operations/permision/listener/OnRequestPermissionResultHandleListener;->onPermissionGranted(Landroid/app/Activity;ILjava/util/List;)V
...
.method public varargs requestPermission(Landroid/app/Activity;I[Ljava/lang/String;)V
    ...
    .line 2
    :cond_0
    iput p2, p0, Lcom/gpc/operations/permision/impl/GPCPermission;->requestCode:I
...
.method public setRequestPermissionResultHandleListener(Lcom/gpc/operations/permision/listener/OnRequestPermissionResultHandleListener;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/gpc/operations/permision/impl/GPCPermission;->listener:Lcom/gpc/operations/permision/listener/OnRequestPermissionResultHandleListener;
