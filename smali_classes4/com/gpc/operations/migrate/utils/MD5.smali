.class public Lcom/gpc/operations/migrate/utils/MD5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/gpc/operations/migrate/utils/MD5;->PADDING:[B
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->state:[J
    ...
    iput-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->count:[J
    ...
    iput-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->buffer:[B
    ...
    iput-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->digest:[B

    .line 6
    invoke-direct {p0}, Lcom/gpc/operations/migrate/utils/MD5;->md5Init()V
...
.method private Decode([J[BI)V
    ...
    invoke-static {v2}, Lcom/gpc/operations/migrate/utils/MD5;->b2iu(B)J
    ...
    invoke-static {v4}, Lcom/gpc/operations/migrate/utils/MD5;->b2iu(B)J
...
.method private FF(JJJJJJJ)J
    ...
    .line 1
    invoke-direct/range {v2 .. v8}, Lcom/gpc/operations/migrate/utils/MD5;->F(JJJ)J
...
.method private GG(JJJJJJJ)J
    ...
    .line 1
    invoke-direct/range {v2 .. v8}, Lcom/gpc/operations/migrate/utils/MD5;->G(JJJ)J
...
.method private HH(JJJJJJJ)J
    ...
    .line 1
    invoke-direct/range {v2 .. v8}, Lcom/gpc/operations/migrate/utils/MD5;->H(JJJ)J
...
.method private II(JJJJJJJ)J
    ...
    .line 1
    invoke-direct/range {v2 .. v8}, Lcom/gpc/operations/migrate/utils/MD5;->I(JJJ)J
...
.method private md5Final()V
    ...
    .line 2
    iget-object v2, p0, Lcom/gpc/operations/migrate/utils/MD5;->count:[J

    invoke-direct {p0, v1, v2, v0}, Lcom/gpc/operations/migrate/utils/MD5;->Encode([B[JI)V
    ...
    .line 5
    :goto_0
    sget-object v3, Lcom/gpc/operations/migrate/utils/MD5;->PADDING:[B

    invoke-direct {p0, v3, v2}, Lcom/gpc/operations/migrate/utils/MD5;->md5Update([BI)V

    .line 6
    invoke-direct {p0, v1, v0}, Lcom/gpc/operations/migrate/utils/MD5;->md5Update([BI)V

    .line 7
    iget-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->digest:[B

    iget-object v1, p0, Lcom/gpc/operations/migrate/utils/MD5;->state:[J

    const/16 v2, 0x10

    invoke-direct {p0, v0, v1, v2}, Lcom/gpc/operations/migrate/utils/MD5;->Encode([B[JI)V
...
.method private md5Init()V
    ...
    .line 1
    iget-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->count:[J
    ...
    .line 3
    iget-object v0, p0, Lcom/gpc/operations/migrate/utils/MD5;->state:[J
...
.method private md5Transform([B)V
    ...
    .line 1
    iget-object v0, v2, Lcom/gpc/operations/migrate/utils/MD5;->state:[J
    ...
    .line 6
    invoke-direct {v2, v0, v12, v11}, Lcom/gpc/operations/migrate/utils/MD5;->Decode([J[BI)V
    ...
    invoke-direct/range {v2 .. v16}, Lcom/gpc/operations/migrate/utils/MD5;->FF(JJJJJJJ)J
    ...
    invoke-direct/range {v2 .. v16}, Lcom/gpc/operations/migrate/utils/MD5;->GG(JJJJJJJ)J
    ...
    invoke-direct/range {v2 .. v16}, Lcom/gpc/operations/migrate/utils/MD5;->HH(JJJJJJJ)J
    ...
    invoke-direct/range {v2 .. v16}, Lcom/gpc/operations/migrate/utils/MD5;->II(JJJJJJJ)J
...
.method private md5Update([BI)V
    ...
    .line 2
    iget-object v1, p0, Lcom/gpc/operations/migrate/utils/MD5;->count:[J
    ...
    .line 9
    iget-object v1, p0, Lcom/gpc/operations/migrate/utils/MD5;->buffer:[B
    ...
    invoke-direct/range {v0 .. v5}, Lcom/gpc/operations/migrate/utils/MD5;->md5Memcpy([B[BIII)V

    .line 10
    iget-object v1, p0, Lcom/gpc/operations/migrate/utils/MD5;->buffer:[B

    invoke-direct {p0, v1}, Lcom/gpc/operations/migrate/utils/MD5;->md5Transform([B)V
...
.method public getMD5ofBytes(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, p1, v0}, Lcom/gpc/operations/migrate/utils/MD5;->md5Update([BI)V

    .line 7
    invoke-direct {p0}, Lcom/gpc/operations/migrate/utils/MD5;->md5Final()V

    .line 9
    iget-object p1, p0, Lcom/gpc/operations/migrate/utils/MD5;->digest:[B
...
.method public getMD5ofStr(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/gpc/operations/migrate/utils/MD5;->digest:[B

    aget-byte v1, v1, p1

    invoke-static {v1}, Lcom/gpc/operations/migrate/utils/MD5;->byteHEX(B)Ljava/lang/String;
