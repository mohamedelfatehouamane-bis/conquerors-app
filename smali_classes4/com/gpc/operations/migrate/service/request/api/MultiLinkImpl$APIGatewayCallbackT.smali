.class public abstract Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl;
.end annotation
...
.method public constructor <init>(Ljava/util/List;Lcom/gpc/operations/migrate/service/request/api/HTTPServiceCallback;Lcom/gpc/operations/migrate/utils/common/ServiceURLBuilder;Landroid/content/Context;)V
    ...
    .line 2
    iput-object p2, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->listener:Lcom/gpc/operations/migrate/service/request/api/HTTPServiceCallback;

    .line 3
    iput-object p3, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->serviceURLBuilder:Lcom/gpc/operations/migrate/utils/common/ServiceURLBuilder;

    .line 4
    iput-object p4, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->context:Landroid/content/Context;

    .line 5
    iput-object p1, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->prefixes:Ljava/util/List;
...
.method private isNeedRetry(Lcom/gpc/operations/migrate/service/network/http/HTTPException;)Z
    ...
    const-string v3, "ServerListAPIGatewayImp"
...
.method private isNeedRetry(Lcom/gpc/operations/migrate/service/network/http/response/HTTPResponse;)Z
    ...
    const-string v2, "ServerListAPIGatewayImp"
...
.method public onConnectionError(Lcom/gpc/operations/migrate/service/network/http/request/HTTPRequest;Lcom/gpc/operations/migrate/service/network/http/HTTPException;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->prefixes:Ljava/util/List;
    ...
    .line 2
    invoke-direct {p0, p2}, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->isNeedRetry(Lcom/gpc/operations/migrate/service/network/http/HTTPException;)Z
    ...
    .line 3
    iget-object p2, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->prefixes:Ljava/util/List;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->repeat(Ljava/util/List;Lcom/gpc/operations/migrate/service/network/http/request/HTTPRequest;)V

    return-void

    .line 6
    :cond_0
    iget-object v0, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->listener:Lcom/gpc/operations/migrate/service/request/api/HTTPServiceCallback;
...
.method public onResponse(Lcom/gpc/operations/migrate/service/network/http/request/HTTPRequest;Lcom/gpc/operations/migrate/service/network/http/response/HTTPResponse;)V
    ...
    .line 4
    invoke-direct {p0, p2}, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->isNeedRetry(Lcom/gpc/operations/migrate/service/network/http/response/HTTPResponse;)Z
    ...
    .line 12
    :cond_0
    invoke-direct {p0, p2}, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->canSelectThisPrefixe(Lcom/gpc/operations/migrate/service/network/http/response/HTTPResponse;)Z
    ...
    iget-object v2, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->prefixes:Ljava/util/List;
    ...
    .line 16
    iget-object v0, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->serviceURLBuilder:Lcom/gpc/operations/migrate/utils/common/ServiceURLBuilder;

    iget-object v1, p0, Lcom/gpc/operations/migrate/service/request/api/MultiLinkImpl$APIGatewayCallbackT;->context:Landroid/content/Context;
