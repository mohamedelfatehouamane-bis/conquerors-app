.class final Lcom/gpc/aws/util/json/JacksonFactory$JacksonWriter;
.super Ljava/lang/Object;
.source "JacksonFactory.java"

# interfaces
.implements Lcom/gpc/aws/util/json/AwsJsonWriter;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/gpc/aws/util/json/JacksonFactory;
.end annotation
...
.method public constructor <init>(Lcom/fasterxml/jackson/core/JsonFactory;Ljava/io/Writer;)V
    ...
    iput-object p1, p0, Lcom/gpc/aws/util/json/JacksonFactory$JacksonWriter;->writer:Lcom/fasterxml/jackson/core/JsonGenerator;
    :try_end_0
...
# virtual methods
.method public beginArray()Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    ...
    .line 216
    iget-object v0, p0, Lcom/gpc/aws/util/json/JacksonFactory$JacksonWriter;->writer:Lcom/fasterxml/jackson/core/JsonGenerator;
...
.method public beginObject()Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public endArray()Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public endObject()Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public name(Ljava/lang/String;)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value()Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value(D)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value(J)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value(Ljava/lang/Number;)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value(Ljava/lang/String;)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value(Ljava/nio/ByteBuffer;)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 287
    iget-object p1, p0, Lcom/gpc/aws/util/json/JacksonFactory$JacksonWriter;->writer:Lcom/fasterxml/jackson/core/JsonGenerator;

    invoke-static {v1}, Lcom/gpc/aws/util/BinaryUtils;->toBase64([B)Ljava/lang/String;
...
.method public value(Ljava/util/Date;)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public value(Z)Lcom/gpc/aws/util/json/AwsJsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
