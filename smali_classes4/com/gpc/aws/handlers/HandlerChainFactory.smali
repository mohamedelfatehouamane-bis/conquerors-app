.class public Lcom/gpc/aws/handlers/HandlerChainFactory;
...
.method private createRequestHandlerChain(Ljava/lang/String;Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 80
    invoke-static {p1, v3}, Lcom/gpc/aws/util/ClassLoaderHelper;->loadClass(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/Class;
    ...
    .line 85
    const-class p1, Lcom/gpc/aws/handlers/RequestHandler2;

    if-ne p2, p1, :cond_3

    .line 86
    check-cast v1, Lcom/gpc/aws/handlers/RequestHandler2;
    ...
    .line 88
    :cond_3
    const-class p1, Lcom/gpc/aws/handlers/RequestHandler;

    if-ne p2, p1, :cond_4

    .line 89
    check-cast v1, Lcom/gpc/aws/handlers/RequestHandler;

    .line 90
    invoke-static {v1}, Lcom/gpc/aws/handlers/RequestHandler2;->adapt(Lcom/gpc/aws/handlers/RequestHandler;)Lcom/gpc/aws/handlers/RequestHandler2;
...
.method public newRequestHandler2Chain(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 58
    const-class v0, Lcom/gpc/aws/handlers/RequestHandler2;

    invoke-direct {p0, p1, v0}, Lcom/gpc/aws/handlers/HandlerChainFactory;->createRequestHandlerChain(Ljava/lang/String;Ljava/lang/Class;)Ljava/util/List;
...
.method public newRequestHandlerChain(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 45
    const-class v0, Lcom/gpc/aws/handlers/RequestHandler;
