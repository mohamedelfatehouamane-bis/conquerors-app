...
.method public execute(Lcom/unity3d/services/core/network/model/HttpRequest;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v1}, Lcom/unity3d/services/core/network/core/CronetClient$execute$2$cronetRequest$1;-><init>(Lkotlinx/coroutines/CancellableContinuation;)V

    check-cast v4, Lorg/chromium/net/UrlRequest$Callback;
    ...
    .line 32
    invoke-virtual {v2, v3, v4, v1}, Lorg/chromium/net/CronetEngine;->newUrlRequestBuilder(Ljava/lang/String;Lorg/chromium/net/UrlRequest$Callback;Ljava/util/concurrent/Executor;)Lorg/chromium/net/UrlRequest$Builder;
    ...
    invoke-virtual {p1}, Lcom/unity3d/services/core/network/model/RequestType;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, p1}, Lorg/chromium/net/UrlRequest$Builder;->setHttpMethod(Ljava/lang/String;)Lorg/chromium/net/UrlRequest$Builder;
