...
.method public visitFrame(II[Ljava/lang/Object;I[Ljava/lang/Object;)V
    ...
    .line 204
    sget-object v7, Lorg/objectweb/asm/Opcodes;->TOP:Ljava/lang/Integer;

    if-eq v6, v7, :cond_5

    .line 205
    sget-object v7, Lorg/objectweb/asm/commons/LocalVariablesSorter;->OBJECT_TYPE:Lorg/objectweb/asm/Type;

    .line 206
    sget-object v8, Lorg/objectweb/asm/Opcodes;->INTEGER:Ljava/lang/Integer;

    if-ne v6, v8, :cond_0

    .line 207
    sget-object v7, Lorg/objectweb/asm/Type;->INT_TYPE:Lorg/objectweb/asm/Type;

    goto :goto_1

    .line 208
    :cond_0
    sget-object v8, Lorg/objectweb/asm/Opcodes;->FLOAT:Ljava/lang/Integer;

    if-ne v6, v8, :cond_1

    .line 209
    sget-object v7, Lorg/objectweb/asm/Type;->FLOAT_TYPE:Lorg/objectweb/asm/Type;

    goto :goto_1

    .line 210
    :cond_1
    sget-object v8, Lorg/objectweb/asm/Opcodes;->LONG:Ljava/lang/Integer;

    if-ne v6, v8, :cond_2

    .line 211
    sget-object v7, Lorg/objectweb/asm/Type;->LONG_TYPE:Lorg/objectweb/asm/Type;

    goto :goto_1

    .line 212
    :cond_2
    sget-object v8, Lorg/objectweb/asm/Opcodes;->DOUBLE:Ljava/lang/Integer;

    if-ne v6, v8, :cond_3

    .line 213
    sget-object v7, Lorg/objectweb/asm/Type;->DOUBLE_TYPE:Lorg/objectweb/asm/Type;
    ...
    invoke-static {v7}, Lorg/objectweb/asm/Type;->getObjectType(Ljava/lang/String;)Lorg/objectweb/asm/Type;
    ...
    :cond_4
    :goto_1
    invoke-direct {p0, v1, v7}, Lorg/objectweb/asm/commons/LocalVariablesSorter;->remap(ILorg/objectweb/asm/Type;)I

    move-result v7

    invoke-direct {p0, v7, v6}, Lorg/objectweb/asm/commons/LocalVariablesSorter;->setFrameLocal(ILjava/lang/Object;)V
    ...
    .line 226
    :goto_3
    iget-object v9, p0, Lorg/objectweb/asm/commons/LocalVariablesSorter;->remappedLocalTypes:[Ljava/lang/Object;
    ...
    .line 233
    :cond_b
    iget-object p3, p0, Lorg/objectweb/asm/commons/LocalVariablesSorter;->remappedLocalTypes:[Ljava/lang/Object;
    ...
    .line 238
    invoke-super/range {v6 .. v11}, Lorg/objectweb/asm/MethodVisitor;->visitFrame(II[Ljava/lang/Object;I[Ljava/lang/Object;)V

    .line 241
    iput-object v2, p0, Lorg/objectweb/asm/commons/LocalVariablesSorter;->remappedLocalTypes:[Ljava/lang/Object;
    ...
    const-string p2, "LocalVariablesSorter only accepts expanded frames (see ClassReader.EXPAND_FRAMES)"
