...
.method public accept(Lorg/objectweb/asm/ClassVisitor;)V
    ...
    .line 374
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->sourceFile:Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, v0}, Lorg/objectweb/asm/ClassVisitor;->visitSource(Ljava/lang/String;Ljava/lang/String;)V

    .line 378
    :cond_1
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->module:Lorg/objectweb/asm/tree/ModuleNode;

    if-eqz p1, :cond_2

    .line 379
    invoke-virtual {p1, v1}, Lorg/objectweb/asm/tree/ModuleNode;->accept(Lorg/objectweb/asm/ClassVisitor;)V

    .line 382
    :cond_2
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->nestHostClass:Ljava/lang/String;

    if-eqz p1, :cond_3

    .line 383
    invoke-virtual {v1, p1}, Lorg/objectweb/asm/ClassVisitor;->visitNestHost(Ljava/lang/String;)V

    .line 386
    :cond_3
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->outerClass:Ljava/lang/String;

    if-eqz p1, :cond_4

    .line 387
    iget-object v0, p0, Lorg/objectweb/asm/tree/ClassNode;->outerMethod:Ljava/lang/String;

    iget-object v2, p0, Lorg/objectweb/asm/tree/ClassNode;->outerMethodDesc:Ljava/lang/String;

    invoke-virtual {v1, p1, v0, v2}, Lorg/objectweb/asm/ClassVisitor;->visitOuterClass(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v5, v0}, Lorg/objectweb/asm/ClassVisitor;->visitAnnotation(Ljava/lang/String;Z)Lorg/objectweb/asm/AnnotationVisitor;
    ...
    invoke-virtual {v1, v5, v2}, Lorg/objectweb/asm/ClassVisitor;->visitAnnotation(Ljava/lang/String;Z)Lorg/objectweb/asm/AnnotationVisitor;
    ...
    .line 406
    invoke-virtual {v1, v5, v6, v7, v0}, Lorg/objectweb/asm/ClassVisitor;->visitTypeAnnotation(ILorg/objectweb/asm/TypePath;Ljava/lang/String;Z)Lorg/objectweb/asm/AnnotationVisitor;
    ...
    .line 414
    invoke-virtual {v1, v4, v5, v6, v2}, Lorg/objectweb/asm/ClassVisitor;->visitTypeAnnotation(ILorg/objectweb/asm/TypePath;Ljava/lang/String;Z)Lorg/objectweb/asm/AnnotationVisitor;
    ...
    .line 419
    :cond_8
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->attrs:Ljava/util/List;
    ...
    invoke-virtual {v1, v3}, Lorg/objectweb/asm/ClassVisitor;->visitAttribute(Lorg/objectweb/asm/Attribute;)V
    ...
    .line 425
    :cond_9
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->nestMembers:Ljava/util/List;
    ...
    .line 431
    :cond_a
    iget-object p1, p0, Lorg/objectweb/asm/tree/ClassNode;->permittedSubclasses:Ljava/util/List;
    ...
    invoke-virtual {v3, v1}, Lorg/objectweb/asm/tree/InnerClassNode;->accept(Lorg/objectweb/asm/ClassVisitor;)V
    ...
    invoke-virtual {v3, v1}, Lorg/objectweb/asm/tree/RecordComponentNode;->accept(Lorg/objectweb/asm/ClassVisitor;)V
    ...
    invoke-virtual {v3, v1}, Lorg/objectweb/asm/tree/FieldNode;->accept(Lorg/objectweb/asm/ClassVisitor;)V
    ...
    invoke-virtual {v0, v1}, Lorg/objectweb/asm/tree/MethodNode;->accept(Lorg/objectweb/asm/ClassVisitor;)V
