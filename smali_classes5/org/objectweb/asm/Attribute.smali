...
.method final computeAttributesSize(Lorg/objectweb/asm/SymbolTable;[BIII)I
    ...
    .line 219
    iget-object v1, p1, Lorg/objectweb/asm/SymbolTable;->classWriter:Lorg/objectweb/asm/ClassWriter;
    ...
    invoke-virtual {p1, v2}, Lorg/objectweb/asm/SymbolTable;->addConstantUtf8(Ljava/lang/String;)I
    ...
    iget p2, p2, Lorg/objectweb/asm/ByteVector;->length:I
    ...
    .line 225
    iget-object v0, v0, Lorg/objectweb/asm/Attribute;->nextAttribute:Lorg/objectweb/asm/Attribute;
...
.method final putAttributes(Lorg/objectweb/asm/SymbolTable;[BIIILorg/objectweb/asm/ByteVector;)V
    ...
    .line 313
    iget-object p3, v0, Lorg/objectweb/asm/Attribute;->type:Ljava/lang/String;

    invoke-virtual {p1, p3}, Lorg/objectweb/asm/SymbolTable;->addConstantUtf8(Ljava/lang/String;)I

    move-result p3

    invoke-virtual {p6, p3}, Lorg/objectweb/asm/ByteVector;->putShort(I)Lorg/objectweb/asm/ByteVector;

    move-result-object p3

    iget p4, p2, Lorg/objectweb/asm/ByteVector;->length:I

    invoke-virtual {p3, p4}, Lorg/objectweb/asm/ByteVector;->putInt(I)Lorg/objectweb/asm/ByteVector;

    .line 314
    iget-object p3, p2, Lorg/objectweb/asm/ByteVector;->data:[B

    const/4 p4, 0x0

    iget p2, p2, Lorg/objectweb/asm/ByteVector;->length:I

    invoke-virtual {p6, p3, p4, p2}, Lorg/objectweb/asm/ByteVector;->putByteArray([BII)Lorg/objectweb/asm/ByteVector;
