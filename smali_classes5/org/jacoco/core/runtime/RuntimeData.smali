...
.method public static generateAccessCall(JLjava/lang/String;ILorg/objectweb/asm/MethodVisitor;)V
    ...
    .line 245
    invoke-virtual {v0, p0}, Lorg/objectweb/asm/MethodVisitor;->visitInsn(I)V
    ...
    invoke-virtual {v0, p0, p1}, Lorg/objectweb/asm/MethodVisitor;->visitTypeInsn(ILjava/lang/String;)V
...
.method public static generateArgumentArray(JLjava/lang/String;ILorg/objectweb/asm/MethodVisitor;)V
    ...
    invoke-virtual {p4, v1, v2}, Lorg/objectweb/asm/MethodVisitor;->visitTypeInsn(ILjava/lang/String;)V
    ...
    invoke-virtual {p4, v1}, Lorg/objectweb/asm/MethodVisitor;->visitLdcInsn(Ljava/lang/Object;)V
...
.method public final collect(Lorg/jacoco/core/data/IExecutionDataVisitor;Lorg/jacoco/core/data/ISessionInfoVisitor;Z)V
    ...
    .line 85
    :try_start_0
    new-instance v2, Lorg/jacoco/core/data/SessionInfo;

    iget-object v3, p0, Lorg/jacoco/core/runtime/RuntimeData;->sessionId:Ljava/lang/String;

    iget-wide v4, p0, Lorg/jacoco/core/runtime/RuntimeData;->startTimeStamp:J

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v6

    invoke-direct/range {v2 .. v7}, Lorg/jacoco/core/data/SessionInfo;-><init>(Ljava/lang/String;JJ)V

    .line 87
    invoke-interface {p2, v2}, Lorg/jacoco/core/data/ISessionInfoVisitor;->visitSessionInfo(Lorg/jacoco/core/data/SessionInfo;)V
