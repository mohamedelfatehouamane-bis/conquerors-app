...
.method static constructor <clinit>()V
    ...
    .line 23
    new-instance v1, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    const-string v3, "OPERATIVE_EVENT_TYPE_SPECIFIED_BY_AD_PLAYER"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;->OPERATIVE_EVENT_TYPE_SPECIFIED_BY_AD_PLAYER:Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    .line 27
    new-instance v3, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    const-string v5, "OPERATIVE_EVENT_TYPE_LOAD_ERROR"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;->OPERATIVE_EVENT_TYPE_LOAD_ERROR:Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    .line 31
    new-instance v5, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    const-string v7, "OPERATIVE_EVENT_TYPE_SHOW_ERROR"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8, v8}, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;->OPERATIVE_EVENT_TYPE_SHOW_ERROR:Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    .line 32
    new-instance v7, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;
    ...
    invoke-direct {v7, v10, v11, v9}, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;->UNRECOGNIZED:Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;

    const/4 v9, 0x5

    .line 14
    new-array v9, v9, [Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;
    ...
    sput-object v9, Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;->$VALUES:[Lgateway/v1/OperativeEventRequestOuterClass$OperativeEventType;
