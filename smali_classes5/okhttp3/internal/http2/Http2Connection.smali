...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iput-object v15, v0, Lokhttp3/internal/http2/Http2Connection;->pushExecutor:Ljava/util/concurrent/ExecutorService;
...
.method private newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-virtual {v4, v3, v1, p1, p2}, Lokhttp3/internal/http2/Http2Writer;->synStream(ZIILjava/util/List;)V
...
.method pushDataLater(ILokio/BufferedSource;IZ)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Connection;->hostname:Ljava/lang/String;
...
.method pushRequestLater(ILjava/util/List;)V
    ...
    invoke-direct {p0, v2}, Lokhttp3/internal/http2/Http2Connection;->pushExecutorExecute(Lokhttp3/internal/NamedRunnable;)V
    :try_end_4
...
.method sendDegradedPingLater()V
    ...
    invoke-direct {v1, p0, v2, v4}, Lokhttp3/internal/http2/Http2Connection$3;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;)V
