...
.method private final canRegisterTrigger()Z
    ...
    .line 175
    :try_start_2
    sget-object v6, Lcom/facebook/appevents/gps/ara/GpsAraTriggersManager;->TAG:Ljava/lang/String;

    const-string v7, "FAILURE_NO_MEASUREMENT_MANAGER_CLASS_DEF"
    ...
    invoke-virtual {v5}, Ljava/lang/NoClassDefFoundError;->toString()Ljava/lang/String;
    ...
    const-string v7, "FAILURE_NO_MEASUREMENT_MANAGER_CLASS"
...
.method public final registerTrigger(Ljava/lang/String;Lcom/facebook/appevents/AppEvent;)V
    ...
    .line 59
    :try_start_1
    const-class v6, Landroid/adservices/measurement/MeasurementManager;

    invoke-static {v4, v6}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/adservices/measurement/MeasurementManager;
    ...
    invoke-static {v4}, Landroid/adservices/measurement/MeasurementManager;->get(Landroid/content/Context;)Landroid/adservices/measurement/MeasurementManager;
    ...
    .line 111
    invoke-virtual {v6, p1, v3, p2}, Landroid/adservices/measurement/MeasurementManager;->registerTrigger(Landroid/net/Uri;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    ...
    check-cast p2, Landroid/adservices/common/AdServicesOutcomeReceiver;
    ...
    .line 138
    invoke-virtual {v6, p1, v3, p2}, Landroid/adservices/measurement/MeasurementManager;->registerTrigger(Landroid/net/Uri;Ljava/util/concurrent/Executor;Landroid/adservices/common/AdServicesOutcomeReceiver;)V
    :try_end_1
    ...
    const-string v3, "FAILURE_TRIGGER_REGISTRATION_NO_METHOD_FOUND"
    ...
    .line 154
    invoke-virtual {v5, v2, p2}, Lcom/facebook/appevents/gps/GpsDebugLogger;->log(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string v3, "FAILURE_TRIGGER_REGISTRATION_NO_CLASS_FOUND"
    ...
    const-string v3, "FAILURE_TRIGGER_REGISTRATION_FAILED"
