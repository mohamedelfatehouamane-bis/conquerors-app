...
.method static constructor <clinit>()V
    ...
    invoke-direct {v13, v15, v2}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v15, v2, v4}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v4, v6}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lch/qos/logback/classic/db/names/ColumnName;->ARG2:Lch/qos/logback/classic/db/names/ColumnName;
    ...
    invoke-direct {v4, v6, v8}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lch/qos/logback/classic/db/names/ColumnName;->ARG3:Lch/qos/logback/classic/db/names/ColumnName;
    ...
    invoke-direct {v6, v8, v10}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lch/qos/logback/classic/db/names/ColumnName;->CALLER_FILENAME:Lch/qos/logback/classic/db/names/ColumnName;
    ...
    invoke-direct {v8, v10, v12}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V
    ...
    const-string v12, "CALLER_METHOD"

    const/16 v28, 0x6

    const/16 v14, 0xd

    invoke-direct {v10, v12, v14}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v10, Lch/qos/logback/classic/db/names/ColumnName;->CALLER_METHOD:Lch/qos/logback/classic/db/names/ColumnName;

    new-instance v12, Lch/qos/logback/classic/db/names/ColumnName;

    const/16 v29, 0xd

    const-string v14, "CALLER_LINE"

    move-object/from16 v30, v0

    const/16 v0, 0xe

    invoke-direct {v12, v14, v0}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v12, Lch/qos/logback/classic/db/names/ColumnName;->CALLER_LINE:Lch/qos/logback/classic/db/names/ColumnName;

    new-instance v14, Lch/qos/logback/classic/db/names/ColumnName;

    const/16 v31, 0xe

    const-string v0, "MAPPED_KEY"

    move-object/from16 v32, v1

    const/16 v1, 0xf

    invoke-direct {v14, v0, v1}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v14, Lch/qos/logback/classic/db/names/ColumnName;->MAPPED_KEY:Lch/qos/logback/classic/db/names/ColumnName;
    ...
    invoke-direct {v1, v2, v0}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lch/qos/logback/classic/db/names/ColumnName;->I:Lch/qos/logback/classic/db/names/ColumnName;

    new-instance v2, Lch/qos/logback/classic/db/names/ColumnName;

    const/16 v37, 0x11

    const-string v0, "TRACE_LINE"

    move-object/from16 v38, v1

    const/16 v1, 0x12

    invoke-direct {v2, v0, v1}, Lch/qos/logback/classic/db/names/ColumnName;-><init>(Ljava/lang/String;I)V
