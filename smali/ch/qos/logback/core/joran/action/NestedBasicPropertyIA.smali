...
.method public body(Lch/qos/logback/core/joran/spi/InterpretationContext;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lch/qos/logback/core/joran/action/NestedBasicPropertyIA;->addError(Ljava/lang/String;)V

    return-void

    :cond_0
    iget-object v0, p2, Lch/qos/logback/core/joran/action/IADataForBasicProperty;->parentBean:Lch/qos/logback/core/joran/util/PropertySetter;

    iget-object p2, p2, Lch/qos/logback/core/joran/action/IADataForBasicProperty;->propertyName:Ljava/lang/String;

    invoke-virtual {v0, p2, p1}, Lch/qos/logback/core/joran/util/PropertySetter;->addBasicProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2, p1}, Lch/qos/logback/core/joran/util/PropertySetter;->setProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method public isApplicable(Lch/qos/logback/core/joran/spi/ElementPath;Lorg/xml/sax/Attributes;Lch/qos/logback/core/joran/spi/InterpretationContext;)Z
    ...
    iget-object p2, p0, Lch/qos/logback/core/joran/action/NestedBasicPropertyIA;->context:Lch/qos/logback/core/Context;
