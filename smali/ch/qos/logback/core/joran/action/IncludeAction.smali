...
.method private getEventName(Lch/qos/logback/core/joran/event/SaxEvent;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p1, p1, Lch/qos/logback/core/joran/event/SaxEvent;->localName:Ljava/lang/String;
...
.method private openURL(Ljava/net/URL;)Ljava/io/InputStream;
    ...
    invoke-virtual {p0, p1, v0}, Lch/qos/logback/core/joran/action/IncludeAction;->optionalWarning(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method protected processInclude(Lch/qos/logback/core/joran/spi/InterpretationContext;Ljava/net/URL;)V
    ...
    const-string v0, "Failed processing ["
    ...
    invoke-static {v2, p2}, Lch/qos/logback/core/joran/util/ConfigurationWatchListUtil;->addToWatchList(Lch/qos/logback/core/Context;Ljava/net/URL;)V
    ...
    invoke-virtual {v2, v3}, Lch/qos/logback/core/joran/event/SaxEventRecorder;->setContext(Lch/qos/logback/core/Context;)V

    invoke-virtual {v2, v1}, Lch/qos/logback/core/joran/event/SaxEventRecorder;->recordEvents(Ljava/io/InputStream;)V

    invoke-direct {p0, v2}, Lch/qos/logback/core/joran/action/IncludeAction;->trimHeadAndTail(Lch/qos/logback/core/joran/event/SaxEventRecorder;)V
    ...
    invoke-virtual {p1, v2, v3}, Lch/qos/logback/core/joran/spi/EventPlayer;->addEventsDynamically(Ljava/util/List;I)V
    :try_end_0
    ...
    invoke-virtual {p0, p2, p1}, Lch/qos/logback/core/joran/action/IncludeAction;->optionalWarning(Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_1
