...
.method public addAppender(Lch/qos/logback/core/Appender;)V
    ...
    invoke-virtual {p0, p1}, Lch/qos/logback/core/AsyncAppenderBase;->addWarn(Ljava/lang/String;)V
...
.method public stop()V
    ...
    const-string v0, "Max queue flush timeout ("
    ...
    invoke-virtual {v2}, Lch/qos/logback/core/AsyncAppenderBase$Worker;->interrupt()V

    new-instance v2, Lch/qos/logback/core/util/InterruptUtil;

    iget-object v3, p0, Lch/qos/logback/core/AsyncAppenderBase;->context:Lch/qos/logback/core/Context;

    invoke-direct {v2, v3}, Lch/qos/logback/core/util/InterruptUtil;-><init>(Lch/qos/logback/core/Context;)V

    :try_start_0
    invoke-virtual {v2}, Lch/qos/logback/core/util/InterruptUtil;->maskInterruptFlag()V

    iget-object v3, p0, Lch/qos/logback/core/AsyncAppenderBase;->worker:Lch/qos/logback/core/AsyncAppenderBase$Worker;

    iget v4, p0, Lch/qos/logback/core/AsyncAppenderBase;->maxFlushTime:I

    int-to-long v4, v4

    invoke-virtual {v3, v4, v5}, Lch/qos/logback/core/AsyncAppenderBase$Worker;->join(J)V

    iget-object v3, p0, Lch/qos/logback/core/AsyncAppenderBase;->worker:Lch/qos/logback/core/AsyncAppenderBase$Worker;

    invoke-virtual {v3}, Lch/qos/logback/core/AsyncAppenderBase$Worker;->isAlive()Z
    ...
    const-string v0, " queued events were possibly discarded."
    ...
    :cond_1
    const-string v0, "Queue flush finished successfully within timeout."
    ...
    :goto_0
    invoke-virtual {v2}, Lch/qos/logback/core/util/InterruptUtil;->unmaskInterruptFlag()V
    ...
    :try_start_1
    iget-object v3, p0, Lch/qos/logback/core/AsyncAppenderBase;->blockingQueue:Ljava/util/concurrent/BlockingQueue;
    ...
    const-string v1, " queued events may be discarded."
