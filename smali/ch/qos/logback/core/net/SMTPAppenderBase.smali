...
.method private buildSessionFromProperties()Ljavax/mail/Session;
    ...
    const-string v3, "mail.smtp.ssl.enable"
...
.method protected sendBuffer(Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V
    ...
    invoke-interface {v3}, Lch/qos/logback/core/Layout;->getPresentationFooter()Ljava/lang/String;
    ...
    invoke-interface {v3}, Lch/qos/logback/core/Layout;->getFileFooter()Ljava/lang/String;
    ...
    :cond_3
    const-string v3, "Undefined subject"

    iget-object v4, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->subjectLayout:Lch/qos/logback/core/Layout;

    if-eqz v4, :cond_5

    invoke-interface {v4, p2}, Lch/qos/logback/core/Layout;->doLayout(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->session:Ljavax/mail/Session;

    invoke-direct {v4, v5}, Ljavax/mail/internet/MimeMessage;-><init>(Ljavax/mail/Session;)V

    iget-object v5, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->from:Ljava/lang/String;

    if-eqz v5, :cond_6

    invoke-virtual {p0, v5}, Lch/qos/logback/core/net/SMTPAppenderBase;->getAddress(Ljava/lang/String;)Ljavax/mail/internet/InternetAddress;

    move-result-object v5

    invoke-virtual {v4, v5}, Ljavax/mail/internet/MimeMessage;->setFrom(Ljavax/mail/Address;)V
    ...
    invoke-virtual {v4, v3, v5}, Ljavax/mail/internet/MimeMessage;->setSubject(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_7
    sget-object v6, Lch/qos/logback/core/net/SMTPAppenderBase;->EMPTY_IA_ARRAY:[Ljavax/mail/internet/InternetAddress;
    ...
    invoke-virtual {v4, v6, v5}, Ljavax/mail/internet/MimeMessage;->setRecipients(Ljavax/mail/Message$RecipientType;[Ljavax/mail/Address;)V

    iget-object v6, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->layout:Lch/qos/logback/core/Layout;

    invoke-interface {v6}, Lch/qos/logback/core/Layout;->getContentType()Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Lch/qos/logback/core/util/ContentTypeUtil;->isTextual(Ljava/lang/String;)Z
    ...
    iget-object v7, p0, Lch/qos/logback/core/net/SMTPAppenderBase;->charsetEncoding:Ljava/lang/String;

    invoke-static {v6}, Lch/qos/logback/core/util/ContentTypeUtil;->getSubType(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v1, v2, v7, v6}, Ljavax/mail/internet/MimeBodyPart;->setText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v6}, Ljavax/mail/internet/MimeBodyPart;->setContent(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v2}, Ljavax/mail/internet/MimeMessage;->setContent(Ljavax/mail/Multipart;)V

    invoke-virtual {p0, v4, p1, p2}, Lch/qos/logback/core/net/SMTPAppenderBase;->updateMimeMsg(Ljavax/mail/internet/MimeMessage;Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V

    new-instance p1, Ljava/util/Date;

    invoke-direct {p1}, Ljava/util/Date;-><init>()V

    invoke-virtual {v4, p1}, Ljavax/mail/internet/MimeMessage;->setSentDate(Ljava/util/Date;)V
...
.method protected updateMimeMsg(Ljavax/mail/internet/MimeMessage;Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
